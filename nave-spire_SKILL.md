...
name: nave-spire
description: >
  Production-grade engineering reference for Nave & Spire — a Next.js 16 design-audit journal
  comparing two Singapore parish SPAs (BSC sapphire + Fraunces vs OLL Marian blue + Cormorant)
